            ...
            <section>
                <div class="wrapper">
                    <div class="inner">
                        ...
                        <h4 class={styles.inexperienced_ttl}>学習コンテンツの例</h4>
                        <div class={styles.inexperienced_container}>
                            <div class={styles.inexperienced_content}>
                                <Image
                                    ...
                                    height={150}
                                />
                                <div class={styles.inexperienced_group}>
                                    <p>STEP1</p>
                                    <h5>Webデザイン</h5>
                                    <h5>HTML・CSSの基礎学習</h5>
                                </div>
                        ...
                        <p class={styles.study_period}>8〜12ヶ月ほど</p>
                        <h4 class={styles.inexperienced_ttl}>学べる理由</h4>
                        <div class={styles.inexperienced_reason_container}>
                            <div class={styles.inexperienced_reason_content}>
                                <h6>フロントエンド</h6>
                                <div class={styles.reason_img}>
                                    <div class={styles.reason_icon_name}>
                                        <Image
                        ...
                        <p class={styles.inexperienced_reason_txt}>
            ...
            <section class="p-service">
                <div class="wrapper">
                    <div class="inner">
                        ...
                        <div class={styles.p_service_container}>
                            <div class={serviceStyles.p_service_content}>
                                <Image
                                    ...
                                    height={361}
                                />
                                <div class={styles.p_service_group}>
                                    <h4 class={styles.job_school_ttl}>ITソリューション事業</h4>
                                    <h5 class={styles.job_school_sub}>各種業界のクライアント企業様へIT・BPOサービスの提供</h5>
                                    <p>
                            ...
                            <div class={`${serviceStyles.p_service_content} ${serviceStyles.p_service_education}`}>
                                <div class={styles.p_service_group}>
                                    <h4 class={styles.job_school_ttl}>新規事業開発</h4>
                                    <h5 class={styles.job_school_sub}>SaaS、AIなど幅広いWebサービスの開発</h5>
                                    <p>
                            ...
                            <div class={serviceStyles.p_service_content}>
                                ...
                                />
                                <div class={styles.p_service_group}>
                                    <h4 class={styles.job_school_ttl}>Web制作・運用</h4>
                                    <h5 class={styles.job_school_sub}>大手企業様のHP制作、ECサイトの構築運用</h5>
                                    <p>
                        ...
                        <table class={styles.work_summary}>
                            <tbody>
                                <tr class={styles.summary_list}>
                                    <th>勤務地</th>
                        ...
                        <div class={styles.eligibility_container}>
                            <h4>こんな想いを持った方からの応募をお待ちしています！</h4>
                            <div class={styles.eligility_content}>
                                <div class={styles.eligility_group}>
                                    <Image
            ...
            <section class="flow">
                <div class="wrapper">
                    <div class="inner">
                        ...
                        <div class={academyStyles.flow_container}>
                            <div class={academyStyles.flow_content}>
                                <div class={academyStyles.flow_ttl}>
                                    <p>1</p>
                                    <h4>エントリー</h4>
                                </div>
                            ...
                            <div class={academyStyles.flow_content}>
                                ...
                                <p class={academyStyles.no_border}>最終面接を通過された方には、内定のご連絡をいたします。条件面の調整や入社手続きを進め、ご入社に向けた準備をサポートいたします。</p>
                            </div>
                            <div class={styles.flow_submit_btn}>
                                <a href="">エントリーする</a>
                            </div>
                        </div>
                    </div>
